      ...
      <section className="hero-dark grid-pattern py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mb-4">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-heading mb-5" style={{ letterSpacing: "-0.03em" }}>
              AI Automation Solutions for{" "}
              <span className="gradient-text-blue-cyan">Small & Mid-Sized Businesses</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl leading-relaxed">
              Done-for-you systems that replace expensive manual work. One-time build. You own it. No recurring fees.
            </p>
          </div>
        </div>
      </section>

      {/* Services Client Component - Handles all service items with modals */}
      <ServicesClient />
